...
out_channels = 1
in_channels = 9 #Change Accordingly

folder = "T1"  #Change Accordingly

Loss_Plot_Path = f"Objective 2/UNET/Output_1.0/{folder}/{folder}_loss_plot.png"
Loss_CSV_Path = f"Objective 2/UNET/Output_1.0/{folder}/{folder}_loss.csv"
Checkpoint_Path = f"Objective 2/UNET/Output_1.0/{folder}/{folder}_model.pth.tar"
